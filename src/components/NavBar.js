...
const CustomLink = ({href, title, className=""}) => {
  ...
  return(
    <Link href={href} className={`${className} relative group`}>
      ...
      <span className={`h-[1px] inline-block bg-black 
  ...
  return (
    ...
    >
        ...
        <nav className="flex items-center justify-center flex-wrap">
            <motion.a href="https://twitter.com/subhransuchinu8" target={"_blank"} 
            whileHover={{y:-2 }}
            whileTap={{scale:0.9}}
            className="w-6 mr-3"
            > <TwitterIcon /> </motion.a>
            <motion.a href="https://github.com/subhransuchinu8" target={"_blank"}
            whileHover={{y:-2 }}
            whileTap={{scale:0.9}}
            className="w-6 mx-3"
             > <GithubIcon /> </motion.a>
            <motion.a href="https://www.linkedin.com/in/subhransu-patra-516522203/" target={"_blank"}
            whileHover={{y:-2 }}
            whileTap={{scale:0.9}}
            className="w-6 mx-3"
